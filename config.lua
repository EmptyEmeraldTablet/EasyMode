...
return {
    ENEMY_SPEED_FACTOR = 20,              -- Enemy move speed (0.4 = 60% reduction)
    BOSS_SPEED_FACTOR = 1,               -- Boss move speed (0.7 = 30% reduction)
    PROJECTILE_SPEED_FACTOR = 1.5,         -- Enemy projectile speed (0.7 = 30% reduction)
    TEAR_SPEED_FACTOR = 0.8,               -- Enemy tear speed (0.7 = 30% reduction)
    ROCK_WAVE_SPEED_FACTOR = 0.9,          -- Rock/Wave projectile speed (0.6 = 40% reduction)
    BOMB_EXPLOSION_DELAY_MULTIPLIER = 1.5, -- Extend bomb explosion time (1.5x)
    ATTACK_COOLDOWN_MULTIPLIER = 1,      -- Attack cooldown multiplier
